...
public class BlackHolePreparingState : SkillState
{
    ...
    public BlackHolePreparingState(Skill skill) : base(skill)
    {
    ...
    public override void UpdateState()
    {
        ...
        if (Physics.Raycast(ray, out hit, Mathf.Infinity, groundLayer))
        {
            ...
            {
                skill.ChangeState(new BlackHoleInstallState(skill, targetPosition));
            }
        }
